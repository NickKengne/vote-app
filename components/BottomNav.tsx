...
import { Home, LogIn, ScissorsLineDashed, Settings, User } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <div className="bg-background h-auto z-50 fixed bottom-2 h-[50px] p-2 w-[100%] max-w-[400px] gap-1 flex  justify-center">
      <Link
        href={"/"}
